...
class TerceiraTela : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTitle("Tela 3") // Define o título da atividade como "Tela 3"
        ...
        nextButton.setOnClickListener {
            // Cria uma intenção para iniciar a próxima atividade (QuartaTela)
            val intent = Intent(this, QuartaTela::class.java)
            startActivity(intent)
        }

        backButton.setOnClickListener {
            // Cria uma intenção para voltar para a atividade anterior (SegundaTela)
